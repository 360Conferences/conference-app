...
class SpeakerView extends StatefulWidget {
  ...
  @override
  _SpeakerState createState() => new _SpeakerState();
}
      ...
      builder: (BuildContext context, AsyncSnapshot<Event> snapshot) {
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            ...
            List<Speaker> speakers = result.values.map((item) => Speaker.fromData(item)).toList();
...
class SpeakerTile extends StatelessWidget {
  ...
  void _showSpeakerDetail(BuildContext context, Speaker speaker) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => SpeakerDetailView(speaker: speaker)),
    );
  }
